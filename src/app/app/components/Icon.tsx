...
// System's app shell gets clean line icons WITHOUT bumping tec-ui to 2.x (a coordinated
// breaking palette change). Paths mirror @yasser172/tec-ui (lucide-style, 24-grid).
import type { CSSProperties } from 'react';

export type SystemIconName = 'shield' | 'layers' | 'heart' | 'settings' | 'chevron-right';
...
export function Icon({
  ...
  name: SystemIconName; size?: number; color?: string; strokeWidth?: number; style?: CSSProperties;
}) {
  return (
    <svg
